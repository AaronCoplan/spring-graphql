...
public class GraphQLController {
    ...
    public Map<String, Object> executeOperation(@RequestBody Map<String, Object> body) {
        ...
        var variables = castedVariables != null ? castedVariables : new LinkedHashMap<String, Object>();

        var executionInput = ExecutionInput.newExecutionInput(query).variables(variables);
